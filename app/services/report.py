...
from app.repositories.reports.report import MostRequestedIngredientStrategy, MonthWithMostRevenueStrategy, TopCustomersStrategy
...
def get_report():
    ...
    month_with_more_revenue = report_controller.generate_report()

    report_controller.set_strategy(TopCustomersStrategy())
    top_customers = report_controller.generate_report()

    return jsonify(most_requested_ingredient=most_requested_ingredient, 
